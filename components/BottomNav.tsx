              ...
              return (
                ...
                >
                  <div className={`w-14 h-14 rounded-full flex items-center justify-center border-4 border-white dark:border-slate-900 transition-all shadow-xl ${
                    isActive
                      ? "bg-gradient-to-br from-blue-500 to-indigo-600 shadow-blue-300/50 scale-105"
                      : "bg-gradient-to-br from-blue-500 to-indigo-600 shadow-blue-200/60 hover:from-blue-400 hover:to-indigo-500"
                  } active:scale-95`}>
            ...
            return (
              ...
              >
                <div className={`p-1.5 rounded-xl transition-all ${isActive ? "bg-blue-100 dark:bg-blue-900/40" : ""}`}>
                  <Icon
                    size={22}
                    className={`transition-colors ${isActive ? "text-blue-600 dark:text-blue-400" : "text-slate-400 dark:text-slate-500"}`}
                    strokeWidth={isActive ? 2.5 : 1.8}
                  />
                </div>
                <span className={`text-[10px] font-semibold transition-colors ${isActive ? "text-blue-600 dark:text-blue-400" : "text-slate-400 dark:text-slate-500"}`}>
                  {item.label}
                </span>
              </button>
            );
