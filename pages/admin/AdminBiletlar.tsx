...
const AdminBiletlar: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-10">
      ...
      {msg && (
        <div className={`mx-6 mt-4 p-3 rounded-xl text-sm font-bold text-center ${msg.startsWith("✅") ? "bg-green-100 text-green-700" : msg.startsWith("Xato") ? "bg-red-100 text-red-700" : "bg-blue-100 text-blue-700"}`}>
          {msg}
        </div>
      )}
          ...
          <div className="p-5 space-y-4">
            ...
            <div className={`flex items-center justify-between p-3 rounded-xl border-2 ${selectedIds.length === 10 ? "bg-green-50 dark:bg-green-900/20 border-green-400" : "bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700"}`}>
              ...
              <button
                ...
                className="flex items-center gap-1.5 bg-indigo-500 hover:bg-indigo-600 text-white px-3 py-1.5 rounded-xl text-xs font-bold transition-all"
              >
