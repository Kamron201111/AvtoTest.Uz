      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          <button
            ...
            onClick={onClick}
            disabled={!onClick}
            className={`bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 text-left transition-all ${onClick ? 'hover:shadow-md hover:border-blue-200 dark:hover:border-blue-800 cursor-pointer' : 'cursor-default'}`}
          >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
                {[
                  ...
                  >
                    <Icon className={`w-5 h-5 flex-shrink-0 ${primary ? 'text-blue-100' : 'text-slate-400'}`} />
                    <div className="min-w-0">
                      <p className={`font-bold text-sm truncate ${primary ? 'text-white' : 'text-slate-700 dark:text-slate-200'}`}>{label}</p>
                      <p className={`text-xs truncate ${primary ? 'text-blue-200' : 'text-slate-400'}`}>{desc}</p>
                    </div>
                  </button>
                ))}
              </div>
                    ...
                    <div key={req.id} className="p-5 space-y-4">
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex items-start gap-3">
                          <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center text-white font-black flex-shrink-0">
        ...
        {tab === 'settings' && (
          <div className="p-5 space-y-5">
            ...
            <div className="space-y-3">
              <h3 className="font-bold text-slate-700 dark:text-slate-200 text-sm flex items-center gap-2">
                <CreditCard className="w-4 h-4 text-blue-500" /> Karta ma'lumotlari
              </h3>
                ...
                {[
                  ...
                  <div key={key} className={full ? 'sm:col-span-2' : ''}>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white rounded-xl outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-sm ${mono ? 'font-mono' : ''}`}
                    />
                  </div>
                ))}
              </div>
                ...
                {[
                  ...
                  <div key={key}>
                    ...
                    <input
                      ...
                      value={localSettings[key] || ''}
                      onChange={e => setLocalSettings(p => ({ ...p, [key]: e.target.value }))}
                      className="w-full px-3 py-3 border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white rounded-xl outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-sm font-mono"
                    />
                  </div>
                ))}
              </div>
                ...
                {[
                  ...
                  <div key={key}>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white rounded-xl outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-sm resize-none"
                    />
                  </div>
                ))}
              </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                ...
                className="flex-1 py-3.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold shadow-lg shadow-blue-200 dark:shadow-blue-900/30 disabled:opacity-50 flex items-center justify-center gap-2 transition-all"
              >
                {savingSettings
      ...
      {showPassModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 w-full max-w-sm shadow-2xl">
            ...
            <input
              type="password"
              className="w-full border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 p-3 rounded-xl mb-4 text-slate-900 dark:text-white outline-none focus:border-blue-500 font-mono"
            ...
            <div className="flex gap-2">
              ...
              <button onClick={handlePasswordChange} className="flex-1 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold transition-all">Saqlash</button>
            </div>
          </div>
        </div>
      )}
