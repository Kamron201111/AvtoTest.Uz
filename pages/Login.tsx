      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 dark:from-blue-900 dark:via-indigo-900 dark:to-slate-900 p-12 flex-col justify-between relative overflow-hidden">
          ...
          <div className="space-y-4 max-w-md">
            {[
              ...
              <div key={title} className="flex items-start gap-4 p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 transition-all">
                ...
                <div><h3 className="text-white font-semibold mb-1">{title}</h3><p className="text-blue-200 text-sm">{desc}</p></div>
              </div>
            ))}
          </div>
        </div>
        <div className="z-10 pt-8 border-t border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white/70 text-sm">Dasturchi</p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-6 text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h1 className="text-3xl font-bold text-slate-800 dark:text-white">AvtoTest<span className="text-blue-600">.uz</span></h1>
            </div>
          </div>
              ...
              <>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="text" value={loginName} onChange={e => setLoginName(e.target.value)}
                        className="w-full pl-9 pr-4 py-3 border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                        placeholder="Kamron201" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type={showPass ? "text" : "password"} value={loginPass} onChange={e => setLoginPass(e.target.value)}
                        className="w-full pl-9 pr-10 py-3 border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                        placeholder="••••••••" />
                  ...
                  <button type="submit" disabled={loading}
                    className="w-full py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg disabled:opacity-50 flex items-center justify-center gap-2">
            ...
            {mode === "register" && (
              <>
                ...
                <form onSubmit={handleRegister} className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="text" value={regFullName} onChange={e => setRegFullName(e.target.value)}
                        className="w-full pl-9 pr-4 py-2.5 border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-sm"
                        placeholder="Valiyev Kamron" />
                    </div>
                  </div>
                  {/* Telefon */}
                  <div>
                  ...
                  {/* Login */}
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Login (Username)</label>
                    <div className="relative">
                      <User size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type={showPass ? "text" : "password"} value={regPass} onChange={e => setRegPass(e.target.value)}
                        className={`w-full pl-9 pr-10 py-2.5 border-2 rounded-xl focus:ring-2 outline-none transition-all text-sm bg-white dark:bg-slate-700 text-slate-900 dark:text-white ${allPassOk ? "border-green-400 focus:ring-green-300" : "border-slate-200 dark:border-slate-600 focus:ring-blue-500 focus:border-blue-500"}`}
                        placeholder="••••••••" />
                      <button type="button" onClick={() => setShowPass(!showPass)}
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600">
                        {showPass ? <EyeOff size={16} /> : <Eye size={16} />}
                  ...
                  <button type="submit" disabled={loading || !allPassOk}
                    className="w-full py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg disabled:opacity-50 flex items-center justify-center gap-2 mt-2">
                ...
                {forgotDone ? (
                  <div className="text-center py-6">
                    ...
                    <button onClick={() => { setMode("login"); setForgotDone(false); setForgotPhone(""); setForgotNewPass(""); }}
                      className="mt-4 px-6 py-2.5 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition-all">
                      Kirish sahifasiga
                    </button>
                  </div>
                ) : (
                  <form onSubmit={handleForgot} className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input type="tel" value={forgotPhone} onChange={e => setForgotPhone(e.target.value)}
                          className="w-full pl-9 pr-4 py-3 border-2 border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                          placeholder="+998901234567" />
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input type={showPass ? "text" : "password"} value={forgotNewPass} onChange={e => setForgotNewPass(e.target.value)}
                          className={`w-full pl-9 pr-10 py-3 border-2 rounded-xl focus:ring-2 outline-none transition-all bg-white dark:bg-slate-700 text-slate-900 dark:text-white ${isPasswordValid(forgotNewPass) ? "border-green-400" : "border-slate-200 dark:border-slate-600 focus:ring-blue-500 focus:border-blue-500"}`}
                          placeholder="••••••••" />
                        <button type="button" onClick={() => setShowPass(!showPass)}
                    ...
                    <button type="submit" disabled={loading || !isPasswordValid(forgotNewPass)}
                      className="w-full py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:opacity-90 transition-all shadow-lg disabled:opacity-50 flex items-center justify-center gap-2">
