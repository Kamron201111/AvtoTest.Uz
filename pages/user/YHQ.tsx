          ...
          <>
                ...
                <div key={ch.id} className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800 shadow-sm">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-black text-sm flex-shrink-0 ${locked ? "bg-slate-100 dark:bg-slate-800 text-slate-400" : "bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400"}`}>
                        {ch.number}
                      </div>
                      <div>
            ...
            {!isPremium && (
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-4 text-white mt-2">
                ...
                <p className="text-blue-200 text-xs mb-3">Premium obuna orqali barcha 29 ta bobni o'qing</p>
